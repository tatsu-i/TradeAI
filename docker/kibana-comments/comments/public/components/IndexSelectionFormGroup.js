        ...
        <Fragment>
          <EuiFlexGroup style={{ maxWidth: 800 }}>
            <EuiFlexItem grow={false} style={{ width: 250 }}>
              <EuiFormRow label="コメントを追加するインデックスを選択してください">
                <EuiSelect
          ...
          buttonContent={<EuiText size="xs">新しいインデックスを作成する</EuiText>}
          paddingSize="m"
          >
            <EuiFlexGroup style={{ maxWidth: 800 }}>
              <EuiFlexItem>
                <EuiFormRow label="新しいインデックス名">
                  <EuiFormControlLayout
                  prepend={<EuiFormLabel htmlFor="createCommentIndexInput">{this.indexPrefix}</EuiFormLabel>}
                  append={<EuiButtonEmpty onClick={this.handleNewIndexCreate}>作成</EuiButtonEmpty>}
                  >
                    <input type="text"
