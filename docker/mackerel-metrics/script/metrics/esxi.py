...
def host_info(host, port=443, user="root", password="password", alias="esxi-server"):
    ...
    dnshost = content.searchIndex.FindByDnsName(dnsName=host, vmSearch=False)
    if  dnshost == None:
        dnshost = content.searchIndex.FindByDnsName(dnsName=alias, vmSearch=False)
